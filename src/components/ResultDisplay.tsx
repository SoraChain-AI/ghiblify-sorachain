...
const ResultDisplay = ({ 
  ...
  return (
    <div className="ghibli-card w-full max-w-2xl p-6 md:p-8 animate-scale-up">
      ...
      <div className="bg-gradient-to-r from-ghibli-blue to-ghibli-purple bg-opacity-10 rounded-lg p-4 flex flex-col sm:flex-row items-center justify-between">
        <div className="mb-4 sm:mb-0">
          ...
          <p className="text-sm text-muted-foreground">
            Earn SoraTokens as proof of your contribution
          </p>
        </div>
        ...
        <Button 
          ...
          className="ghibli-button min-w-[140px]"
        >
