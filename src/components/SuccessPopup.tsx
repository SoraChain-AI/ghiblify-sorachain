...
const SuccessPopup = ({ open, onOpenChange }: SuccessPopupProps) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white rounded-lg border-4 border-ghibli-green border-opacity-50 max-w-md">
        <DialogHeader className="text-center">
          ...
          <DialogDescription className="text-lg font-medium text-ghibli-dark">
            You've helped make SoraChain AI smarter by 20%! 🎉
          </DialogDescription>
        </DialogHeader>
        
        <div className="p-4 bg-gradient-to-r from-ghibli-blue/10 to-ghibli-purple/10 rounded-lg text-center">
          <p className="text-sm text-muted-foreground">
            Your contribution has been recorded on the blockchain and 
            you've earned SoraTokens as a reward!
          </p>
        </div>
      </DialogContent>
    </Dialog>
